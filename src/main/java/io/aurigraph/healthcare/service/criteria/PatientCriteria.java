...
/**
 * Criteria class for the {@link io.aurigraph.healthcare.domain.Patient} entity. This class is used
 * in {@link io.aurigraph.healthcare.web.rest.PatientResource} to receive all the possible filtering options from
...
public class PatientCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, firstName, lastName, email, gender, age, mobileNumber, distinct);
    }
