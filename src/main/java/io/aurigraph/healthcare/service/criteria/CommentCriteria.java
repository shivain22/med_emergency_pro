...
/**
 * Criteria class for the {@link io.aurigraph.healthcare.domain.Comment} entity. This class is used
 * in {@link io.aurigraph.healthcare.web.rest.CommentResource} to receive all the possible filtering options from
...
public class CommentCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, comment, patientId, distinct);
    }
