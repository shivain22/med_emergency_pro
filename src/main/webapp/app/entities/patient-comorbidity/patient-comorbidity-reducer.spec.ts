...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './patient-comorbidity.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PATIENTCOMORBIDITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_PATIENTCOMORBIDITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PATIENTCOMORBIDITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PATIENTCOMORBIDITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PATIENTCOMORBIDITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PATIENTCOMORBIDITY actions', async () => {
      const expectedActions = [
        {
