...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PATIENTVITAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_PATIENTVITAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PATIENTVITAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PATIENTVITAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PATIENTVITAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PATIENTVITAL actions', async () => {
      const expectedActions = [
        {
