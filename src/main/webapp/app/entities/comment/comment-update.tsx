...
export const CommentUpdate = () => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...commentEntity,
          patient: commentEntity?.patient?.id,
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="auriHealthCareApp.comment.home.createOrEditLabel" data-cy="CommentCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Comment" id="comment-comment" name="comment" data-cy="comment" type="text" />
              <ValidatedField id="comment-patient" name="patient" data-cy="patient" label="Patient" type="select" required>
                <option value="" key="0" />
                {patients
