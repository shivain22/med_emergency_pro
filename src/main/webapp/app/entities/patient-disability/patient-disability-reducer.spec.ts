...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './patient-disability.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PATIENTDISABILITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_PATIENTDISABILITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PATIENTDISABILITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PATIENTDISABILITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PATIENTDISABILITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PATIENTDISABILITY actions', async () => {
      const expectedActions = [
        {
