...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISABILITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_DISABILITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DISABILITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DISABILITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DISABILITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DISABILITY actions', async () => {
      const expectedActions = [
        {
