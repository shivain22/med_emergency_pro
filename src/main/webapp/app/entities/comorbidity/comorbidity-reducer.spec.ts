...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMORBIDITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMORBIDITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMORBIDITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMORBIDITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMORBIDITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMORBIDITY actions', async () => {
      const expectedActions = [
        {
